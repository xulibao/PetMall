...
#import "UIImageView+GHExtension.h"
...
@interface GHImageObserver : NSObject
...
@implementation GHImageObserver
...
@implementation UIImageView (GHExtension)
...
- (GHImageObserver *)imageObserver {
    GHImageObserver *imageObserver = objc_getAssociatedObject(self, @selector(imageObserver));
    if (!imageObserver) {
        imageObserver = [[GHImageObserver alloc] initWithImageView:self];
