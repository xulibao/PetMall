...
@implementation SATableViewHeaderFooterView
...
//    tableViewSectionHeaderBackgroundColor = UIColorMake(244, 244, 244);
//    tableViewSectionFooterBackgroundColor = UIColorMake(244, 244, 244);
//    tableViewSectionHeaderFont = UIFontBoldMake(12);                                            //
    return self;
}
...
- (void)setType:(SATableViewHeaderFooterViewType)type {
    _type = type;
//    [self updateStyleIfCan];
}
