...
- (void)addTableView {
    ...
    UITableView * tabbleView = [[UITableView alloc]initWithFrame:CGRectMake(self.tableViews.count * kMainBoundsWidth, 0, kMainBoundsWidth, _contentView.height)];
...
- (void)fecthData{
    ...
    NSArray * jsonObjectArray =[NSJSONSerialization JSONObjectWithData:data
                                                               options:kNilOptions
                                                                 error:&error];
    self.dataSouce  = [YWAddressModel mj_objectArrayWithKeyValuesArray:jsonObjectArray];
...
- (void)topBarItemClick:(UIButton *)btn {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        self.contentView.contentOffset = CGPointMake(index * kMainBoundsWidth, 0);
        [self changeUnderLineFrame:btn];
    }];
}
...
- (void)setUpAddress:(NSString *)address {
    ...
    NSInteger index = self.contentView.contentOffset.x / kMainBoundsWidth;
...
- (void)scrollToNextItem:(NSString *)preTitle {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        self.contentView.contentSize = (CGSize){self.tableViews.count * kMainBoundsWidth,0};
        CGPoint offset = self.contentView.contentOffset;
        self.contentView.contentOffset = CGPointMake(offset.x + kMainBoundsWidth, offset.y);
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        NSInteger index = scrollView.contentOffset.x / kMainBoundsWidth;
...
- (void)setAreaCode:(NSString *)areaCode {
    ...
    self.contentView.contentSize = (CGSize){self.tableViews.count * kMainBoundsWidth,0};
    CGPoint offset = self.contentView.contentOffset;
    self.contentView.contentOffset = CGPointMake((self.tableViews.count - 1) * kMainBoundsWidth, offset.y);
