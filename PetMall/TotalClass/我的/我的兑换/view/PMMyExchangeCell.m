...
@end
@implementation PMMyExchangeCell
...
- (void)initViews{
    ...
    [_rightButton setTitleColor:[UIColor colorWithHexStr:@"#FF3945"] forState:UIControlStateNormal];
    [_rightButton setTitle:@"再次兑换" forState:UIControlStateNormal];
