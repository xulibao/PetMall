...
@end
@implementation PMIntegralMallCell
...
- (void)tableView:(UITableView *)tableView configViewWithData:(PMIntegralMallItem *)data AtIndexPath:(NSIndexPath *)indexPath {
...
- (void)rightButtonClick{
    ...
    if ([self.cellDelegate respondsToSelector:@selector(PMIntegralMallCellDidClick:)]) {
        [self.cellDelegate PMIntegralMallCellDidClick:self];
    }
}
@end
