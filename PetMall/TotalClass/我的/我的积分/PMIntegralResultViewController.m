//
//  PMIntegralResultViewController.m
//  PetMall
//
...
@interface PMIntegralResultViewController ()

@end

@implementation PMIntegralResultViewController
...
- (void)fectchSubViews{
    ...
    imageView.image = IMAGE(@"order_duihuan_succuss");
    ...
    [bidBtn setTitle:@"立即评价" forState:UIControlStateNormal];
