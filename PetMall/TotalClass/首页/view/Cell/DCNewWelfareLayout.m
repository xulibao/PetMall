...
-(UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath {
    ...
    layoutAttrbutes.frame = CGRectMake(0, self.overallHeight, kMainBoundsWidth, height);
...
- (void)layoutAttributesForCustomOneLayout:(UICollectionViewLayoutAttributes *)layoutAttributes indexPath: (NSIndexPath *) indexPath {
    ...
    CGFloat itemH = 85;
    CGFloat itemW = kMainBoundsWidth / 2.0;
    switch (indexPath.item) {
        ...
        case 2:
            ...
            layoutAttributes.frame = CGRectMake(0, itemH, kMainBoundsWidth, itemH);
            self.overallHeight += itemH;
            break;
        default:
            break;
