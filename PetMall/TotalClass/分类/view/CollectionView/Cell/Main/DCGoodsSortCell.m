...
- (void)layoutSubviews
{
    ...
    [_goodsTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        [make.top.mas_equalTo(_goodsImageView.mas_bottom)setOffset:15];
...
- (void)setSubItem:(DCCalssSubItem *)subItem{
    _subItem = subItem;
    [_goodsImageView sd_setImageWithURL:[NSURL URLWithString:subItem.img] placeholderImage:IMAGE(@"common_normal")];
